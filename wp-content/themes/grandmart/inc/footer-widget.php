...
class GrandMart_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'grandmart';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'grandmart' ), $i ),
...
// Initialize.
$grandmart_footer_widgets = new GrandMart_Footer_Widgets();
